...
public class TestNGListener implements ITestListener {
	...
	public void onFinish(ITestContext result) {
		System.out.println("TestCases finish and TestCase details are:"+result.getName());
	...
	public void onTestFailedButWithinSuccessPercentage(ITestResult result) {
		System.out.println("TestCases failedwithinsuccess and TestCase details are:"+result.getName());
